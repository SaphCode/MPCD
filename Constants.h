...
namespace MPCD {
	namespace Constants {
		...
		constexpr double const_force = 0.01; // 1 at the moment, kg (particle mass) * m (1) / s^2 (unit of time) about 10^-20, so a = 10^3 seems reasonable, but its really small force
